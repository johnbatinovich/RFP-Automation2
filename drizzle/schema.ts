...
export const rfps = mysqlTable("rfps", {
  ...
  owner: varchar("owner", { length: 255 }).default(null),
  rfpDocumentUrl: text("rfpDocumentUrl").default(null),
  rfpDocumentName: varchar("rfpDocumentName", { length: 255 }).default(null),
  rfpContent: text("rfpContent").default(null),
  uploadedBy: varchar("uploadedBy", { length: 255 }).default(null),
  extractedQuestions: text("extractedQuestions").default(null),
  createdAt: timestamp("createdAt").defaultNow(),
